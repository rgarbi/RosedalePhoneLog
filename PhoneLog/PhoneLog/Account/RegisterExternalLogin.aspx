<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Account/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="PhoneLog.Account.RegisterExternalLogin" %>
